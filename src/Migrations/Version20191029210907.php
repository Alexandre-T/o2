...
final class Version20191029210907 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE te_askedvat (id INT AUTO_INCREMENT NOT NULL, customer_id INT UNSIGNED NOT NULL COMMENT \'User identifier\', accountant_id INT UNSIGNED DEFAULT NULL COMMENT \'User identifier\', vat NUMERIC(4, 4) NOT NULL, status SMALLINT NOT NULL, code VARCHAR(63) DEFAULT NULL, created_at DATETIME NOT NULL, INDEX ndx_askedvat_customer (customer_id), INDEX ndx_askedvat_accountant (accountant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB COMMENT = \'Store customers asking new VAT profile and accountant decisions\' ');
        ...
        $this->addSql('ALTER TABLE ts_user ADD vat NUMERIC(4, 4) NULL');
        $this->addSql('ALTER TABLE ts_user ADD bill_indication VARCHAR(63) DEFAULT NULL');
        $this->addSql('UPDATE ts_user SET vat=\'0.2000\' WHERE vat IS NULL');
        $this->addSql('ALTER TABLE ts_user MODIFY vat NUMERIC(4, 4) NOT NULL');
    }
}
