...
class ProgrammationVoter extends Voter
{
    /*
     * Constants.
     */
     ...
     * @param Programmation  $subject   subject is a programmation, thanks to the supports method
    ...
    /**
     * This programmation can be showed only if it's owned by user.
     *
    ...
    {
        return $programmation->getCustomer() === $user;
    }
}
